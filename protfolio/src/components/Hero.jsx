      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center md:justify-start order-2 md:order-1">
            <div className="relative group">
              ...
              <div className="relative">
                {/* Decorative ring */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl blur opacity-70 group-hover:opacity-100 transition duration-300"></div>
          ...
          <div className="text-center md:text-left order-1 md:order-2">
            ...
            <p className="mt-3 text-gray-400 text-lg sm:text-xl italic">
              Are you Java? Because without you, I feel null.🫥
            </p>
            
            <p className="mt-4 text-gray-400 text-lg sm:text-xl max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <div className="flex flex-wrap gap-3 w-full md:w-auto justify-center md:justify-start mt-4 md:mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/10 hover:bg-white/20 transition-colors duration-200 rounded-lg px-4 py-2 text-white flex items-center space-x-2"
                >
