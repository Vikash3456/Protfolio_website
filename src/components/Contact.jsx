...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-primary min-h-screen flex items-center">
      <div className="w-full">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-4 text-secondary">Have a question or want to work together? Feel free to reach out!</div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="bg-secondary/5 rounded-2xl p-6 backdrop-blur-sm border border-accent/10">
              <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                <input type="hidden" name="_captcha" value="false" />
                <div>
                  <label htmlFor="user_name" className="block text-sm font-medium text-primary mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-2 bg-secondary/5 border border-accent/10 rounded-lg text-primary placeholder-secondary focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent/30"
                    placeholder="Your name"
                  />
                </div>

                <div>
                  <label htmlFor="user_email" className="block text-sm font-medium text-primary mb-2">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="user_message" className="block text-sm font-medium text-primary mb-2">
                    Message
                  </label>
                  <textarea
                    id="user_message"
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-accent/10 text-accent rounded-lg hover:bg-accent/20 transition-colors duration-200 disabled:opacity-50"
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="mailto:vikashkush29@gmail.com" className="text-secondary hover:text-accent transition-colors duration-200">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-4">Social Links</h3>
                <div className="flex space-x-4">
                  <a
                    href="https://github.com/Vikash3456"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-accent/10 rounded-lg text-secondary hover:text-accent hover:bg-accent/20 transition-colors duration-200"
                  >
